...
function gr(e, n, t, r, l) {
	...
	if (((u = 0), (r = r === "" ? "." : r + ":"), Iu(e)))
		...
		for (e = s.call(e), o = 0; !(i = e.next()).done; )
			(i = i.value), (s = r + wl(i, o++)), (u += gr(i, n, t, s, l));
	else if (i === "object")
		throw (
			((n = String(e)),
			Error(
...
L.cloneElement = function (e, n, t) {
	...
	if (n != null) {
		if (
			(n.ref !== void 0 && ((i = n.ref), (u = Bi.current)),
	...
	return { $$typeof: Xt, type: e.type, key: l, ref: i, props: r, _owner: u };
};
			...
			e: for (var W = 0, G = x.length, bt = G >>> 1; W < bt; ) {
				...
				if (0 > l(gl, T))
					yn < G && 0 > l(er, gl)
						? ((x[W] = er), (x[yn] = T), (W = yn))
						: ((x[W] = gl), (x[vn] = T), (W = vn));
				else if (yn < G && 0 > l(er, T)) (x[W] = er), (x[yn] = T), (W = yn);
				else break e;
			}
		}
		return z;
...
function ei(e, n) {
	...
	n.hasOwnProperty("value")
		? ni(e, n.type, t)
		: n.hasOwnProperty("defaultValue") && ni(e, n.type, fn(n.defaultValue)),
		n.checked == null &&
...
function Ac(e) {
	...
	for (var t = e, r = n; ; ) {
		...
		if (l.child === i.child) {
			for (i = l.child; i; ) {
				if (i === t) return Ku(l), e;
				if (i === r) return Ku(l), n;
				i = i.sibling;
			}
			throw Error(y(188));
		}
...
function ws(e) {
	return (e = Ac(e)), e !== null ? ks(e) : null;
}
function ks(e) {
...
function eu(e, n, t, r) {
	if (Dr) {
		var l = di(e, n, t, r);
		if (l === null) Ml(e, n, r, Ir, t), Xu(e, r);
		else if (bc(l, e, n, t, r)) r.stopPropagation();
		else if ((Xu(e, r), n & 4 && -1 < qc.indexOf(e))) {
			for (; l !== null; ) {
				var i = Jt(l);
				if (
					(i !== null && Ns(i),
...
function Tf(e, n) {
	if (Dn)
		return e === "compositionend" || (!lu && Ms(e, n))
			? ((e = js()), (Sr = nu = en = null), (Dn = !1), e)
			: null;
	switch (e) {
		case "paste":
			return null;
...
function lo() {
	Ct && (Ct.detachEvent("onpropertychange", Us), (Ft = Ct = null));
}
function Us(e) {
	if (e.propertyName === "value" && rl(Ft)) {
		var n = [];
		Is(n, Ft, e, Zi(e)), ys(Rf, n);
	}
}
function Of(e, n, t) {
	e === "focusin"
		? (lo(), (Ct = n), (Ft = t), Ct.attachEvent("onpropertychange", Us))
		: e === "focusout" && lo();
}
function Mf(e) {
...
function Ys(e, n) {
	...
	if (jr) throw ((e = ai), (jr = !1), (ai = null), e);
}
function D(e, n) {
	var t = n[wi];
...
function co(e, n, t, r, l) {
	for (var i = n._reactName, u = []; t !== null && t !== r; ) {
		...
		o.tag === 5 &&
			...
			((o = c),
			l
				? ((s = Ot(t, i)), s != null && u.unshift(At(t, s, o)))
				: l || ((s = Ot(t, i)), s != null && u.push(At(t, s, o)))),
			(t = t.return);
	}
...
var gi = typeof setTimeout == "function" ? setTimeout : void 0,
	...
	Kf =
		typeof queueMicrotask == "function"
			...
			: typeof po < "u"
			? function (e) {
					return po.resolve(null).then(e).catch(Yf);
			  }
			: gi;
function Yf(e) {
	setTimeout(function () {
...
function hn() {
	if (!Il && Ae !== null) {
		...
		try {
			...
			throw (Ae !== null && (Ae = Ae.slice(e + 1)), Ss(Ji, hn), l);
		} finally {
			(O = n), (Il = !1);
		}
	}
...
function la(e) {
	...
	function k(f, a, d, v) {
		...
		if (R.done) return t(f, _), U && gn(f, N), E;
		if (_ === null) {
...
function nd(e, n, t) {
	...
	if (xa(e)) Ca(n, l);
		...
		(t = ea(e, n, l, r)),
			t !== null && ((l = ue()), je(t, e, r, l), _a(t, n, r));
	}
}
function xa(e) {
	var n = e.alternate;
	...
	return (
		...
		e !== null && !ce
			? ((n.updateQueue = e.updateQueue),
			  ...
			  (e.lanes &= ~l),
			  Ye(e, n, l))
			: (U && t && uu(n), (n.flags |= 1), ie(e, n, r, l), n.child)
	);
}
	...
	return (
		...
		e !== null && !ce
			? ((n.updateQueue = e.updateQueue),
			  ...
			  (e.lanes &= ~l),
			  Ye(e, n, l))
			: (U && r && uu(n), (n.flags |= 1), ie(e, n, t, l), n.child)
	);
}
function Ro(e, n, t, r, l) {
	...
	if ((Gn(n, l), n.stateNode === null))
		Nr(e, n), ra(n, t, r), _i(n, t, r, l), (r = !0);
	else if (e === null) {
		var u = n.stateNode,
			o = n.memoizedProps;
		u.props = o;
...
function zi(e, n, t, r, l, i) {
	La(e, n);
	var u = (n.flags & 128) !== 0;
	if (!r && !u) return l && vo(n, t, !1), Ye(e, n, i);
...
function jo(e, n, t, r, l) {
	return bn(), su(l), (n.flags |= 256), ie(e, n, t, r), n.child;
}
	...
	if (t)
		return n.flags & 256
			...
			: ((i = r.fallback),
			  ...
			  (n.child.memoizedState = Li(u)),
			  (n.memoizedState = Ti),
			  i);
	if (!(n.mode & 1)) return mr(e, n, u, null);
	if (l.data === "$!") {
		if (((r = l.nextSibling && l.nextSibling.dataset), r)) var o = r.dgst;
		return (r = o), (i = Error(y(419))), (r = Vl(i, r, void 0)), mr(e, n, u, r);
	}
	...
	if ((ie(e, n, r.children, t), (r = $.current), r & 2))
		...
		if (e !== null && e.flags & 128)
			e: for (e = n.child; e !== null; ) {
				if (e.tag === 13) e.memoizedState !== null && Oo(e, t, n);
				else if (e.tag === 19) Oo(e, t, n);
...
function ad(e, n, t) {
	...
	switch ((ou(n), n.tag)) {
				...
				(e === null || e.child === null) &&
					(dr(n)
						...
						: e === null ||
						  ...
						  ((n.flags |= 1024), Le !== null && ($i(Le), (Le = null)))),
				Ri(e, n),
				te(n),
				null
			);
		...
		case 4:
			return (
				nt(), Ri(e, n), e === null && $t(n.stateNode.containerInfo), te(n), null
			);
		case 10:
...
function dd(e, n) {
	...
	for (vi = { focusedElem: e, selectionRange: t }, Dr = !1, S = n; S !== null; )
...
function Fa(e) {
	...
	n !== null && ((e.alternate = null), Fa(n)),
		...
		e.tag === 5 &&
			((n = e.stateNode),
			n !== null &&
				(delete n[Ie], delete n[Vt], delete n[wi], delete n[Xf], delete n[Gf])),
		(e.stateNode = null),
		(e.return = null),
		(e.dependencies = null),
		...
		case 5:
			...
			if (r & 4 && ((l = e.stateNode), l != null)) {
				...
				if (((e.updateQueue = null), s !== null))
					try {
						o === "input" && i.type === "radio" && i.name != null && os(l, i),
							ii(o, u);
						var c = ii(o, i);
...
function je(e, n, t, r) {
	...
	Gt(e, t, r),
		(!(j & 2) || e !== J) &&
			...
			pe(e, r),
			t === 1 && j === 0 && !(n.mode & 1) && ((rt = Q() + 500), ul && hn()));
}
function pe(e, n) {
	...
	if (r === 0)
		...
		if ((t != null && Yu(t), n === 1))
			e.tag === 0 ? Zf(Ao.bind(null, e)) : Zs(Ao.bind(null, e)),
				Kf(function () {
					!(j & 6) && hn();
				}),
				(t = null);
...
function qr(e, n) {
	...
	while (1);
	if ((cu(), (j = t), (Gr.current = r), K !== null)) throw Error(y(261));
	return (J = null), (b = 0), X;
}
function vd() {
	for (; K !== null; ) Qa(K);
...
Xa = function (e, n, t) {
	...
	else (ce = !1), U && n.flags & 1048576 && Js(n, Br, n.index);
	switch (((n.lanes = 0), n.tag)) {
		case 2:
			var r = n.type;
			Nr(e, n), (e = n.pendingProps);
			var l = qn(n, le.current);
			Gn(n, t), (l = gu(null, n, r, e, l, t));
			var i = wu();
			return (
				(n.flags |= 1),
				typeof l == "object" &&
				...
				l.$$typeof === void 0
					? ((n.tag = 1),
					  ...
					  _i(n, r, e, t),
					  (n = zi(null, n, r, !0, i, t)))
					: ((n.tag = 0), U && i && uu(n), ie(null, n, l, t), (n = n.child)),
				n
			);
		case 16:
			r = n.elementType;
			...
			e: {
				...
				if (((r = u.element), i.isDehydrated))
					if (
						...
						(l = tt(Error(y(423)), n)), (n = jo(e, n, r, t, l));
						break e;
					} else if (r !== l) {
						(l = tt(Error(y(424)), n)), (n = jo(e, n, r, t, l));
						break e;
					} else
						for (
		...
		case 5:
			return (
				...
				(u = l.children),
				yi(r, l) ? (u = null) : i !== null && yi(r, i) && (n.flags |= 32),
				La(e, n),
				ie(e, n, u, t),
				n.child
			);
...
function Pd(e, n, t, r, l) {
	...
	var s = Lu(e, 0, !1, null, null, !1, !1, "", Ho);
	return (
	...
	switch (e.tag) {
		case 3:
			...
			if (n.current.memoizedState.isDehydrated) {
				...
				t !== 0 &&
					(qi(n, t | 1), pe(n, Q()), !(j & 6) && ((rt = Q() + 500), hn()));
			}
			break;
		case 13:
			Tn(function () {
...
hs = Nu;
vs = Tn;
var zd = { usingClientEntryPoint: !1, Events: [Jt, Un, il, ps, ms, Nu] },
	vt = {
...
ge.hydrateRoot = function (e, n, t) {
	...
	if (
		...
		(n = Ja(n, null, e, 1, t ?? null, l, !1, i, u)),
		(e[Qe] = n.current),
		$t(e),
		r)
	)
...
var Wo = Kl;
(Ql.createRoot = Wo.createRoot), (Ql.hydrateRoot = Wo.hydrateRoot);
function Ld() {
	return P.jsxs("div", {
		className: "footer",
		children: [
			...
			". Coded by ",
			P.jsx("a", { href: "#", children: "Prathamesh Chavan" }),
			".",
		],
	});
}
function Rd() {
	return P.jsx("div", {
		...
		children: P.jsxs("div", {
			className: "grid",
			children: [
				P.jsx("button", { className: "btn btn-white", children: "7" }),
				P.jsx("button", { className: "btn btn-white", children: "8" }),
				P.jsx("button", { className: "btn btn-white", children: "9" }),
				P.jsx("button", { className: "btn btn-blue", children: "DEL" }),
				P.jsx("button", { className: "btn btn-white", children: "4" }),
				P.jsx("button", { className: "btn btn-white", children: "5" }),
				P.jsx("button", { className: "btn btn-white", children: "6" }),
				P.jsx("button", { className: "btn btn-white", children: "+" }),
				P.jsx("button", { className: "btn btn-white", children: "1" }),
				P.jsx("button", { className: "btn btn-white", children: "2" }),
				P.jsx("button", { className: "btn btn-white", children: "3" }),
				P.jsx("button", { className: "btn btn-white", children: "-" }),
				P.jsx("button", { className: "btn btn-white", children: "." }),
				P.jsx("button", { className: "btn btn-white", children: "0" }),
				P.jsx("button", { className: "btn btn-white", children: "/" }),
				P.jsx("button", { className: "btn btn-white", children: "x" }),
				P.jsx("button", {
					className: "btn btn-blue span-two",
					children: "RESET",
				}),
				P.jsx("button", { className: "btn btn-red span-two", children: "=" }),
			],
		}),
	});
}
			...
			P.jsxs("div", {
				...
				children: [
					P.jsxs("div", {
						className: "numbers",
						children: [
							P.jsx("div", { children: "1" }),
							P.jsx("div", { children: "2" }),
							P.jsx("div", { children: "3" }),
						],
					}),
					P.jsx("div", {
						className: "slider",
						children: P.jsx("div", { className: "switch" }),
					}),
				],
			}),
		],
...
function Od() {
	return P.jsxs("div", {
		className: "titlebar",
		children: [
			P.jsx("div", { className: "title", children: "calc" }),
			P.jsx(jd, {}),
		],
	});
}
function Md() {
	return P.jsx("div", {
		className: "window",
		children: P.jsx("div", { className: "res", children: "0" }),
	});
}
function Dd() {
	return P.jsxs("div", {
		...
		children: [
			P.jsxs("div", {
				className: "container",
				children: [P.jsx(Od, {}), P.jsx(Md, {}), P.jsx(Rd, {})],
			}),
			P.jsx(Ld, {}),
		],
	});
...
Ql.createRoot(document.getElementById("root")).render(
	P.jsx(gc.StrictMode, { children: P.jsx(Dd, {}) }),
);
